...
<form action="create.php" method="post">
    ...
    <div class="form-group">
        ...
        <input type="number" id="score" name="score" class="form-control" min="1" max="5" value="<?php echo $review['score'] ?>">
    </div>
    <div class="form-group">
        <label for="summary">感想</label>
        <textarea name="summary" id="summary" class="form-control" value="<?php echo $review['summary'] ?>"></textarea>
    </div>
